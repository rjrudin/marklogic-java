...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:db="http://marklogic.com/manage/package/databases">
	...
	<xsl:template match="db:element-word-lexicons">
		<xsl:copy>
			<xsl:apply-templates />
			<xsl:apply-templates select="$mergePackage/db:config/db:package-database-properties/db:element-word-lexicons/db:element-word-lexicon" />
		</xsl:copy>
	</xsl:template>
	...
	<xsl:template match="db:range-element-indexes">
		<xsl:copy>
			<xsl:apply-templates />
			<xsl:apply-templates select="$mergePackage/db:config/db:package-database-properties/db:range-element-indexes/db:range-element-index" />
		</xsl:copy>
	</xsl:template>
	...
	<xsl:template match="db:range-element-attribute-indexes">
		<xsl:copy>
			<xsl:apply-templates />
			<xsl:apply-templates select="$mergePackage/db:config/db:package-database-properties/db:range-element-attribute-indexes/db:range-element-attribute-index" />
		</xsl:copy>
	</xsl:template>
	...
	<xsl:template match="db:range-path-indexes">
		<xsl:copy>
			<xsl:apply-templates />
			<xsl:apply-templates select="$mergePackage/db:config/db:package-database-properties/db:range-path-indexes/db:range-path-index" />
		</xsl:copy>
	</xsl:template>
	...
	<xsl:template match="db:range-field-indexes">
		<xsl:copy>
			<xsl:apply-templates />
			<xsl:apply-templates select="$mergePackage/db:config/db:package-database-properties/db:range-field-indexes/db:range-field-index" />
		</xsl:copy>
	</xsl:template>
	...
	<xsl:template match="db:geospatial-element-indexes">
		<xsl:copy>
			<xsl:apply-templates />
			<xsl:apply-templates select="$mergePackage/db:config/db:package-database-properties/db:geospatial-element-indexes/db:geospatial-element-index" />
		</xsl:copy>
	</xsl:template>
	...
	<xsl:template match="db:geospatial-element-attribute-pair-indexes">
		<xsl:copy>
			<xsl:apply-templates />
			<xsl:apply-templates select="$mergePackage/db:config/db:package-database-properties/db:geospatial-element-attribite-pair-indexes/db:geospatial-element-attribute-pair-index" />
		</xsl:copy>
	</xsl:template>
